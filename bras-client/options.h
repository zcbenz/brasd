...
public:
    ...
    static void add_passwd(const Glib::ustring& username, const Glib::ustring& password) { passwords_[username] = password; }
    static void set_curt(const Glib::ustring& username) { curt_ = username; }
